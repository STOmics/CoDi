...
def create_synthetic(path_to_anndata, percentages = [0.05, 0.1, 0.2, 0.3, 0.5, 0.7, 0.9]):
    ...
    for perc in percentages:
        ...
        adata_fname = path.rstrip('.h5ad') + '_' + str(perc) + '.h5ad'
        adata_copy.write('synthetic_sc_' + str(perc) + '.h5ad')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--percentages', help='Comma separated list of percentages', type=str, required=False, default="0.05,0.1,0.2,0.3,0.5,0.7,0.9")
